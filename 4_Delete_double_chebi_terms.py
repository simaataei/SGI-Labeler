...
file = open("Mid_files/dict_C2GO_overall_CHEBI_filtered_transporter.txt", "r")
contents = file.read()
...
with open('Mid_files/dict_C2GO_overall_CHEBI_filtered_without_double_chebi_transporter.txt', 'w') as d:
...
dataset_to_latex(C2GO_new, acc2GO_swiss,acc2GO_uni,'trans_all_CHEBI_filtered_without_double_chebi_transporter')
a=1
