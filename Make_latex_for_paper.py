...
df_uni_100 = pd.read_csv ('./Dataset/UniProt/ident-100/UniProt-100-transporter_df.csv')
df_uni_100.columns = ['CHEBI','Substrate','UniProt-100']
df_swiss_100 = pd.read_csv ('./Dataset/SwissProt/ident-100/SwissProt-100-transporter_df.csv')
...
df_uni_60 = pd.read_csv ('./Dataset/UniProt/ident-60/UniProt-60-transporter_df.csv')
df_uni_60.columns = ['CHEBI','Substrate','UniProt-60']
df_swiss_60 = pd.read_csv ('./Dataset/SwissProt/ident-60/SwissProt-60-transporter_df.csv')
...
with open('Dataset/Latex/transporter_datasets_latex.txt', 'w') as f:
